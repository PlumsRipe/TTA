...
#cifar100=("cfgs/cifar100_c/source.yaml" "cfgs/cifar100_c/norm_test.yaml" "cfgs/cifar100_c/tent.yaml" "cfgs/cifar100_c/cotta.yaml" "cfgs/cifar100_c/rotta.yaml" "cfgs/cifar100_c/eata.yaml" "cfgs/cifar100_c/sar.yaml" "cfgs/cifar100_c/rottamodify.yaml")
...
imagenet_c=("cfgs/imagenet_c/rotta.yaml" "cfgs/imagenet_c/rottamodify.yaml" "cfgs/imagenet_c/cotta.yaml" )
...
#   architectures=(resnet50 swin_b vit_b_16)
   ...
   for arch in ${architectures[*]}; do
     for var in "${imagenet_c[@]}"; do
       for seed in ${seeds[*]}; do
         python test_time_imagenet_c.py --cfg $var SETTING $setting MODEL.ARCH $arch RNG_SEED $seed $options
       done
     done
   done
