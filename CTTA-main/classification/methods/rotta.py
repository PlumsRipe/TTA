...
class RoTTA(TTAMethod):
    def __init__(self, cfg, model, num_classes):
        ...
        self.update_frequency = cfg.ROTTA.UPDATE_FREQUENCY  # 64
    ...
    def forward_and_adapt(self, x):
        ...
        # add into memory
        for i, data in enumerate(imgs_test):  # imgs_test: 一个batch的数据
...
class CSTU:
    ...
    def add_instance(self, instance):
        ...
        new_score = self.heuristic_score(0, uncertainty)  # 计算启发式得分
